...
namespace Lib.AHP
{
    ...
    /// The client of the class must provide decision making criteria that are scored against each other
    /// via a pairwise comparison (using the 1-9 scale proposed by Saaty) and the choices tht are scored for every criteria also using binary
    /// comparison process. 	
